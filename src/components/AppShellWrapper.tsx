...
import { Avatar, Divider, Icon, IconButton, Image, Link, useDisclosure } from "@chakra-ui/react";
import {
  AppShell,
  Navbar,
  NavbarBrand,
        ...
        sidebar={
          ...
          >
            <SidebarSection>
              ...
              <NavItem fontSize="sm" cursor="pointer" icon={<Icon boxSize={isOpen ? "4" : "5"} as={SiYoutubeshorts} />}>
                Shorts
              </NavItem>
              <NavItem
                fontSize="sm"
            ...
            <SidebarSection>
              <NavItem fontSize="sm" cursor="pointer" icon={<Icon boxSize={isOpen ? "4" : "5"} as={PiUserCircle} />}>
                You
              </NavItem>
